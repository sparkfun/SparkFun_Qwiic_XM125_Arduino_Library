...
sfTkError_t sfDevXM125::getDistanceDetectorError(uint32_t &error)
{
    ...
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_PROTOCOL_STATUS, (uint8_t *)&error, 4, readBytes);
...
sfTkError_t sfDevXM125::getDistanceMeasureCounter(uint32_t &counter)
{
    ...
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_MEASURE_COUNTER, (uint8_t *)&counter, 4, readBytes);
...
sfTkError_t sfDevXM125::getDistanceDetectorStatus(uint32_t &status)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_DETECTOR_STATUS, (uint8_t *)&status, 4, readBytes);
...
sfTkError_t sfDevXM125::getDistancePeak0Distance(uint32_t &peak)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_PEAK0_DISTANCE, (uint8_t *)&peak, 4, readBytes);
...
sfTkError_t sfDevXM125::getDistancePeak1Distance(uint32_t &peak)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_PEAK1_DISTANCE, (uint8_t *)&peak, 4, readBytes);
    peak = sftk_byte_swap(peak);
    return retVal;
}
...
sfTkError_t sfDevXM125::getDistancePeak2Distance(uint32_t &peak)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_PEAK2_DISTANCE, (uint8_t *)&peak, 4, readBytes);
    peak = sftk_byte_swap(peak);
    return retVal;
}
...
sfTkError_t sfDevXM125::getDistancePeak3Distance(uint32_t &peak)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_PEAK3_DISTANCE, (uint8_t *)&peak, 4, readBytes);
    peak = sftk_byte_swap(peak);
    return retVal;
}
...
sfTkError_t sfDevXM125::getDistancePeak4Distance(uint32_t &peak)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_PEAK4_DISTANCE, (uint8_t *)&peak, 4, readBytes);
    peak = sftk_byte_swap(peak);
    return retVal;
}
...
sfTkError_t sfDevXM125::getDistancePeak5Distance(uint32_t &peak)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_PEAK5_DISTANCE, (uint8_t *)&peak, 4, readBytes);
    peak = sftk_byte_swap(peak);
    return retVal;
}
...
sfTkError_t sfDevXM125::getDistancePeak6Distance(uint32_t &peak)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_PEAK6_DISTANCE, (uint8_t *)&peak, 4, readBytes);
    peak = sftk_byte_swap(peak);
    return retVal;
}
...
sfTkError_t sfDevXM125::getDistancePeak7Distance(uint32_t &peak)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_PEAK7_DISTANCE, (uint8_t *)&peak, 4, readBytes);
    peak = sftk_byte_swap(peak);
    return retVal;
}
...
sfTkError_t sfDevXM125::getDistancePeak8Distance(uint32_t &peak)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_PEAK8_DISTANCE, (uint8_t *)&peak, 4, readBytes);
    peak = sftk_byte_swap(peak);
    return retVal;
}
...
sfTkError_t sfDevXM125::getDistancePeak9Distance(uint32_t &peak)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_PEAK9_DISTANCE, (uint8_t *)&peak, 4, readBytes);
    peak = sftk_byte_swap(peak);
    return retVal;
}
...
sfTkError_t sfDevXM125::getDistancePeak0Strength(uint32_t &peak)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_PEAK0_STRENGTH, (uint8_t *)&peak, 4, readBytes);
    peak = sftk_byte_swap(peak);
    peak = peak / 1000;
    return retVal;
}
...
sfTkError_t sfDevXM125::getDistancePeak1Strength(uint32_t &peak)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_PEAK1_STRENGTH, (uint8_t *)&peak, 4, readBytes);
    peak = sftk_byte_swap(peak);
    peak = peak / 1000;
    return retVal;
}
...
sfTkError_t sfDevXM125::getDistancePeak2Strength(uint32_t &peak)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_PEAK2_STRENGTH, (uint8_t *)&peak, 4, readBytes);
    peak = sftk_byte_swap(peak);
    peak = peak / 1000;
    return retVal;
}
...
sfTkError_t sfDevXM125::getDistancePeak3Strength(uint32_t &peak)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_PEAK3_STRENGTH, (uint8_t *)&peak, 4, readBytes);
    peak = sftk_byte_swap(peak);
    peak = peak / 1000;
    return retVal;
}
...
sfTkError_t sfDevXM125::getDistancePeak4Strength(uint32_t &peak)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_PEAK4_STRENGTH, (uint8_t *)&peak, 4, readBytes);
    peak = sftk_byte_swap(peak);
    peak = peak / 1000;
    return retVal;
}
...
sfTkError_t sfDevXM125::getDistancePeak5Strength(uint32_t &peak)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_PEAK5_STRENGTH, (uint8_t *)&peak, 4, readBytes);
    peak = sftk_byte_swap(peak);
    peak = peak / 1000;
    return retVal;
}
...
sfTkError_t sfDevXM125::getDistancePeak6Strength(uint32_t &peak)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_PEAK6_STRENGTH, (uint8_t *)&peak, 4, readBytes);
    peak = sftk_byte_swap(peak);
    peak = peak / 1000;
    return retVal;
}
...
sfTkError_t sfDevXM125::getDistancePeak7Strength(uint32_t &peak)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_PEAK7_STRENGTH, (uint8_t *)&peak, 4, readBytes);
    peak = sftk_byte_swap(peak);
    peak = peak / 1000;
    return retVal;
}
...
sfTkError_t sfDevXM125::getDistancePeak8Strength(uint32_t &peak)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_PEAK8_STRENGTH, (uint8_t *)&peak, 4, readBytes);
    peak = sftk_byte_swap(peak);
    peak = peak / 1000;
    return retVal;
}
...
sfTkError_t sfDevXM125::getDistancePeak9Strength(uint32_t &peak)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_PEAK9_STRENGTH, (uint8_t *)&peak, 4, readBytes);
    peak = sftk_byte_swap(peak);
    peak = peak / 1000;
    return retVal;
}
...
sfTkError_t sfDevXM125::getDistanceMaxStepLength(uint32_t &length)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_MAX_STEP_LENGTH, (uint8_t *)&length, 4, readBytes);
...
sfTkError_t sfDevXM125::getDistanceSignalQuality(uint32_t &signal)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_SIGNAL_QUALITY, (uint8_t *)&signal, 4, readBytes);
...
sfTkError_t sfDevXM125::getDistanceMaxProfile(uint32_t &profile)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_MAX_PROFILE, (uint8_t *)&profile, 4, readBytes);
...
sfTkError_t sfDevXM125::getDistanceThresholdMethod(uint32_t &method)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_THRESHOLD_METHOD, (uint8_t *)&method, 4, readBytes);
...
sfTkError_t sfDevXM125::getDistanceNumFramesRecordedThreshold(uint32_t &thresh)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_NUM_FRAMES_RECORDED_THRESH, (uint8_t *)&thresh, 4, readBytes);
...
sfTkError_t sfDevXM125::getDistanceThresholdSensitivity(uint32_t &thresh)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_THREHSOLD_SENSITIVITY, (uint8_t *)&thresh, 4, readBytes);
    thresh = sftk_byte_swap(thresh);
    return retVal;
}
...
sfTkError_t sfDevXM125::getDistanceReflectorShape(uint32_t &shape)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_DISTANCE_REFLECTOR_SHAPE, (uint8_t *)&shape, 4, readBytes);
...
sfTkError_t sfDevXM125::getPresenceSweepsPerFrame(uint32_t &sweeps)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_INTRA_PRESENCE_SCORE, (uint8_t *)&sweeps, 4, readBytes);
...
sfTkError_t sfDevXM125::getPresenceInterFramePresenceTimeout(uint32_t &time)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_PRESENCE_INTER_FRAME_TIMEOUT, (uint8_t *)&time, 4, readBytes);
...
sfTkError_t sfDevXM125::getPresenceIntraDetectionThreshold(uint32_t &thresh)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_PRESENCE_INTRA_DETECTION_THRESHOLD, (uint8_t *)&thresh, 4, readBytes);
    thresh = sftk_byte_swap(thresh);
    return retVal;
}
...
sfTkError_t sfDevXM125::getPresenceInterFrameDeviationTime(uint32_t &time)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_PRESENCE_INTER_FRAME_DEVIATION, (uint8_t *)&time, 4, readBytes);
    time = sftk_byte_swap(time);
    return retVal;
}
...
sfTkError_t sfDevXM125::getPresenceInterFrameFastCutoff(uint32_t &cut)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_PRESENCE_INTER_FRAME_FAST_CUTOFF, (uint8_t *)&cut, 4, readBytes);
...
sfTkError_t sfDevXM125::getPresenceInterFrameSlowCutoff(uint32_t &cut)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_PRESENCE_INTER_FRAME_SLOW_CUTOFF, (uint8_t *)&cut, 4, readBytes);
    cut = sftk_byte_swap(cut);
    return retVal;
}
...
sfTkError_t sfDevXM125::getPresenceIntraFrameTimeConst(uint32_t &time)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_PRESENCE_INTRA_FRAME_TIME_CONST, (uint8_t *)&time, 4, readBytes);
    time = sftk_byte_swap(time);
    return retVal;
}
...
sfTkError_t sfDevXM125::getPresenceIntraOutputTimeConst(uint32_t &time)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_PRESENCE_INTRA_OUTPUT_TIME_CONST, (uint8_t *)&time, 4, readBytes);
    time = sftk_byte_swap(time);
    return retVal;
}
...
sfTkError_t sfDevXM125::getPresenceInterOutputTimeConst(uint32_t &time)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_PRESENCE_INTER_OUTPUT_TIME_CONST, (uint8_t *)&time, 4, readBytes);
    time = sftk_byte_swap(time);
    return retVal;
}
...
sfTkError_t sfDevXM125::getPresenceManualProfile(uint32_t &prof)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_PRESENCE_MANUAL_PROFILE, (uint8_t *)&prof, 4, readBytes);
...
sfTkError_t sfDevXM125::getPresenceManualStepLength(uint32_t &length)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_PRESENCE_MANUAL_STEP_LENGTH, (uint8_t *)&length, 4, readBytes);
    length = sftk_byte_swap(length);
    return retVal;
}
...
sfTkError_t sfDevXM125::getPresenceDetectionOnGPIO(uint32_t &detected)
{
    size_t readBytes = 0;
    sfTkError_t retVal =
        _theBus->readRegister16Region(SFE_XM125_PRESENCE_DETECTION_ON_GPIO, (uint8_t *)&detected, 4, readBytes);
