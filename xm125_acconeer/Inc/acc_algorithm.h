 ...
 * @param[in] stride Used when calculating rfft of a matrix, for an array set stride = 1
 */
 ...
 * @param[in] data_length Length of data
 * @param[in] stride Used when performing fftshift on a matrix, for an array set stride = 1
 */
 ...
 * @param[in] length_shift Integer that specifies the transform length N in accordance with N = 1 << length_shift and N >= segment_length
 * @param[in] fs Sampling frequency
 * @param[in] stride Used when calculating psd of a matrix, for an array set stride = 1
 */
 ...
 * @param[in] cfar_win_length Number of frequency bins next to the CFAR guard from which the threshold level will be calculated
 * @param[in] cfar_guard_length Number of frequency bins around the point of interest that is omitted when calculating the CFAR threshold
 * @param[in] cfar_sensitivity Sensitivity of the CFAR threshold
