...
typedef struct
{
	...
	/**
	 * Indication of sensor calibration needed. The sensor calibration needs to be redone
...
/**
 * @brief Get the buffer sizes needed given the provided detector handle
 *
...
/**
 * @brief Do a detector recalibration
 *
